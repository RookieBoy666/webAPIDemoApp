...
namespace DC.Client.SystemLib
{
    public class Const
    {
        ...
        public static string StartupPath1 = (Directory.GetParent(System.Environment.CurrentDirectory)).ToString();
        /// <summary>
        /// 为kaiyuan时 管理版现场监控调用
        /// </summary>
        ...
        public static string DBConnFile1 = StartupPath1 + "\\InstallFile\\ProduceInstall.xml";

        public static string DBConnFileZj = StartupPath + "\\Resources\\DataFileZhuJi.xml";
        /// <summary>
        /// 系统类型配置文件
        /// </summary>
        public static string SystemTypeFile = StartupPath + "\\Resources\\SystemType.xml";
        /// <summary>
        /// 服务器数据库连接串
        /// </summary>
